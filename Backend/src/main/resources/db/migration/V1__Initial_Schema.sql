...
CREATE TABLE IF NOT EXISTS users (
                                     ...
                                     email VARCHAR(100) NOT NULL UNIQUE,     -- Thêm UNIQUE cho email để đồng bộ với phone
                                     password VARCHAR(255) NOT NULL,
                                     role_id INT NOT NULL,
                                     phone_number VARCHAR(20) NOT NULL UNIQUE, -- Cập nhật từ V3
                                     date_of_birth DATE NOT NULL,              -- Cập nhật từ V3
                                     gender VARCHAR(20),
