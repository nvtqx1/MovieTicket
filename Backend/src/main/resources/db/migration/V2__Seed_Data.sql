...
INSERT INTO component_types (id, name) VALUES (1, 'RESERVATION_STATUS')
    ON DUPLICATE KEY UPDATE name = 'RESERVATION_STATUS'; -- Tránh lỗi trùng lặp
...
INSERT INTO roles (id, name) VALUES (1, 'ROLE_ADMIN') -- Quyền Quản trị viên
    ON DUPLICATE KEY UPDATE name = 'ROLE_ADMIN';
INSERT INTO roles (id, name) VALUES (2, 'ROLE_USER') -- Quyền Người dùng thông thường
...
INSERT INTO users (user_name, email, password, role_id, age, gender)
SELECT 'admin', 'admin@moviereview.com', '{bcrypt}$2a$12$v7OOmf67vtCyNVQBcqMhbuW6pWgd7i1Z0b35qUQ5S1jkNo8CRNZrG', -- mật khẩu đã hash là 'password'
       (SELECT id FROM roles WHERE name = 'ROLE_ADMIN'), 30, 'MALE'
...
INSERT INTO users (user_name, email, password, role_id, age, gender)
SELECT 'user', 'user@moviereview.com', '{bcrypt}$2a$12$v7OOmf67vtCyNVQBcqMhbuW6pWgd7i1Z0b35qUQ5S1jkNo8CRNZrG', -- cùng mật khẩu
       (SELECT id FROM roles WHERE name = 'ROLE_USER'), 22, 'FEMALE'
...
INSERT INTO users (user_name, email, password, role_id, age, gender) VALUES
                                                                         ('hoang_nguyen', 'hoang@gmail.com', '{bcrypt}$2a$12$v7OOmf67vtCyNVQBcqMhbuW6pWgd7i1Z0b35qUQ5S1jkNo8CRNZrG', 2, 25, 'MALE'),
                                                                         ('thu_thuy', 'thuy@gmail.com', '{bcrypt}$2a$12$v7OOmf67vtCyNVQBcqMhbuW6pWgd7i1Z0b35qUQ5S1jkNo8CRNZrG', 2, 19, 'FEMALE'),
                                                                         ('minh_anh', 'minhanh@gmail.com', '{bcrypt}$2a$12$v7OOmf67vtCyNVQBcqMhbuW6pWgd7i1Z0b35qUQ5S1jkNo8CRNZrG', 2, 35, 'FEMALE')
...
SELECT 1, 'Cineplex', 'Downtown', 150 -- Rạp cỡ trung
    WHERE NOT EXISTS (SELECT 1 FROM theaters WHERE id = 1);

INSERT INTO theaters (id, name, location, capacity)
SELECT 2, 'MovieMax', 'Uptown', 200 -- Rạp cỡ lớn
    WHERE NOT EXISTS (SELECT 1 FROM theaters WHERE id = 2);

INSERT INTO theaters (id, name, location, capacity)
SELECT 3, 'FilmHouse', 'Westside', 100 -- Rạp tư nhân cỡ nhỏ
...
INSERT INTO movies (id, title, genre, release_year, description, poster_image_url) VALUES
                                                                                       (1, 'The Matrix', 'Sci-Fi', 1999, 'A computer hacker learns from mysterious rebels...', 'https://m.media-amazon.com/images/M/MV5BNzQzOTk3OTAtNDQ0Zi00ZTVkLWI0MTEtMDllZjNkYzNjNTc4L2ltYWdlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_.jpg'),
                                                                                       (2, 'Inception', 'Sci-Fi', 2010, 'A thief who steals corporate secrets through the use of dream-sharing...', 'https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_.jpg'),
                                                                                       (3, 'Pulp Fiction', 'Crime', 1994, 'The lives of two mob hitmen, a boxer, a gangster and his wife...', 'https://m.media-amazon.com/images/M/MV5BNGNhMDIzZTUtNTBlZi00MTRlLWFjM2ItYzViMjE3YzI5MjljXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg'),
                                                                                       (4, 'The Dark Knight', 'Action', 2008, 'When the menace known as the Joker wreaks havoc...', 'https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_.jpg'),
                                                                                       (5, 'Fight Club', 'Drama', 1999, 'An insomniac office worker and a devil-may-care soapmaker...', 'https://m.media-amazon.com/images/M/MV5BMmEzNTkxYjQtZTc0MC00YTVjLTg5ZTEtZWMwOWVlYzY0NWIwXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg'),
                                                                                       (6, 'Forrest Gump', 'Drama', 1994, 'The presidencies of Kennedy and Johnson...', 'https://m.media-amazon.com/images/M/MV5BNWIwODRlZTUtY2U3ZS00Yzg1LWJhNzYtMmZiYmEyNmU1NjMzXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_.jpg'),
                                                                                       (7, 'The Lord of the Rings: The Fellowship of the Ring', 'Fantasy', 2001, 'A meek Hobbit from the Shire...', 'https://m.media-amazon.com/images/M/MV5BN2EyZjM3NzUtNWUzMi00MTgxLWI0NTctMzY4M2VlOTdjZWRiXkEyXkFqcGdeQXVyNDUzOTQ5MjY@._V1_.jpg'),
                                                                                       (8, 'Interstellar', 'Sci-Fi', 2014, 'A team of explorers travel through a wormhole...', 'https://m.media-amazon.com/images/M/MV5BZjdkOTU3MDktN2IxOS00OGEyLWFmMjktY2FiMmZkNWIyODZiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg'),
                                                                                       (9, 'The Godfather', 'Crime', 1972, 'The aging patriarch of an organized crime dynasty...', 'https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmUtYTAwNi00MTYxLWJmNWYtYzZlODY3ZTk3OTFlXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg'),
                                                                                       (10, 'Avengers: Endgame', 'Action', 2019, 'After the devastating events of Avengers: Infinity War...', 'https://m.media-amazon.com/images/M/MV5BMTc5MDE2ODcwNV5BMl5BanBnXkFtZTgwMzI2NzQ2NzM@._V1_.jpg')
...
DELETE FROM showtimes WHERE show_date < CURDATE(); -- Xóa các ngày trong quá khứ

-- GIỮ NGUYÊN DANH SÁCH SUẤT CHIẾU
-- BỔ SUNG: Cột is_flash_sale (mặc định false, bật true cho một số suất để test)
INSERT INTO showtimes (id, movie_id, theater_id, show_date, show_time, total_seats, available_seats, price, is_flash_sale) VALUES
                                                                                                                               (1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '18:00:00', 150, 150, 12.99, TRUE),
                                                                                                                               ...
                                                                                                                               (26, 10, 3, DATE_ADD(CURDATE(), INTERVAL 9 DAY), '18:30:00', 100, 100, 14.99, FALSE)
    ON DUPLICATE KEY UPDATE is_flash_sale = VALUES(is_flash_sale);
...
-- Hàng A
(26, 'A1', false), (26, 'A2', false), (26, 'A3', false), (26, 'A4', false), (26, 'A5', false), (26, 'A6', false), (26, 'A7', false), (26, 'A8', false), (26, 'A9', false), (26, 'A10', false),
-- Hàng B
(26, 'B1', false), (26, 'B2', false), (26, 'B3', false), (26, 'B4', false), (26, 'B5', false), (26, 'B6', false), (26, 'B7', false), (26, 'B8', false), (26, 'B9', false), (26, 'B10', false),
-- Hàng C
(26, 'C1', false), (26, 'C2', false), (26, 'C3', false), (26, 'C4', false), (26, 'C5', false), (26, 'C6', false), (26, 'C7', false), (26, 'C8', false), (26, 'C9', false), (26, 'C10', false),
-- Hàng D
(26, 'D1', false), (26, 'D2', false), (26, 'D3', false), (26, 'D4', false), (26, 'D5', false), (26, 'D6', false), (26, 'D7', false), (26, 'D8', false), (26, 'D9', false), (26, 'D10', false),
-- Hàng E
(26, 'E1', false), (26, 'E2', false), (26, 'E3', false), (26, 'E4', false), (26, 'E5', false), (26, 'E6', false), (26, 'E7', false), (26, 'E8', false), (26, 'E9', false), (26, 'E10', false),
-- Hàng F
(26, 'F1', false), (26, 'F2', false), (26, 'F3', false), (26, 'F4', false), (26, 'F5', false), (26, 'F6', false), (26, 'F7', false), (26, 'F8', false), (26, 'F9', false), (26, 'F10', false),
-- Hàng G
(26, 'G1', false), (26, 'G2', false), (26, 'G3', false), (26, 'G4', false), (26, 'G5', false), (26, 'G6', false), (26, 'G7', false), (26, 'G8', false), (26, 'G9', false), (26, 'G10', false),
-- Hàng H
(26, 'H1', false), (26, 'H2', false), (26, 'H3', false), (26, 'H4', false), (26, 'H5', false), (26, 'H6', false), (26, 'H7', false), (26, 'H8', false), (26, 'H9', false), (26, 'H10', false),
-- Hàng I
(26, 'I1', false), (26, 'I2', false), (26, 'I3', false), (26, 'I4', false), (26, 'I5', false), (26, 'I6', false), (26, 'I7', false), (26, 'I8', false), (26, 'I9', false), (26, 'I10', false),
-- Hàng J
(26, 'J1', false), (26, 'J2', false), (26, 'J3', false), (26, 'J4', false), (26, 'J5', false), (26, 'J6', false), (26, 'J7', false), (26, 'J8', false), (26, 'J9', false), (26, 'J10', false);
...
INSERT INTO reviews (user_id, movie_id, rating, comment, upvotes, downvotes) VALUES
                                                                                 (2, 1, 5, 'Phim quá đỉnh, kỹ xảo đi trước thời đại!', 10, 1),
                                                                                 (3, 1, 4, 'Cốt truyện hơi hack não nhưng rất cuốn.', 5, 0),
                                                                                 (2, 2, 5, 'Christopher Nolan chưa bao giờ làm tôi thất vọng.', 20, 2)
...
INSERT INTO review_votes (review_id, user_id, is_upvote) VALUES
                                                             (1, 3, TRUE), -- User 3 thích review của User 2
                                                             (1, 4, TRUE), -- User 4 thích review của User 2
                                                             (1, 5, FALSE) -- User 5 không thích review này
    ON DUPLICATE KEY UPDATE is_upvote = VALUES(is_upvote);

-- Chuyển trạng thái suất chiếu ID 1 và 13 thành Flash Sale
UPDATE showtimes SET is_flash_sale = TRUE WHERE id IN (1, 13);